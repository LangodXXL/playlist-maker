...
val viewModelModule = module {
    ...
    viewModel {
        SearchScreenViewModel(get(), get(), androidApplication(), get())
    }
    viewModel {
    ...
    viewModel {
        TracksInPlaylistViewModel(get(), get(),androidApplication(), get())
    }
    viewModel {
        FavoriteTracksViewModel(get(), get(), androidApplication())
    }
